...
4. For each active workspace found by the script, add verifiable context:
...
5. Write or update the Markdown report under the requested report root. Default root:
   `/Users/bianyuxin/hope-jobs/work_report`.
6. Run `scripts/validate_report.py` with the collector JSON and Markdown report. Fix validation errors before finishing; treat warnings as prompts to add available evidence.
